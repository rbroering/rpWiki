...
<?php
				...
				//case 'version-compare':
					...
					//include_once ('../libraries/finediff/finediff.php');

					#var_dump($this->Version);
					#var_dump($this->Compare);
					#echo $this->Compare['new'];
					//var_dump( get_decorated_diff(str_replace('<', '&lt;', $this->Compare['new']), str_replace('<', '&lt;', $this->Version['new']) ));
				//break;
			}
